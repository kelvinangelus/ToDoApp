...
public class TaskTableModel extends AbstractTableModel{
    ...
    List<Task> tasks = new ArrayList(); //Criação de uma lista de tarefas 
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch(columnIndex){
            ...
            case 1:
                return tasks.get(rowIndex).getDescription(); //Retorna a descrição do projeto selecionado
            case 2:
                SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
                return dateFormat.format(tasks.get(rowIndex).getDeadLine()); //Retorna o prazo do projeto selecionado
            case 3:
                return tasks.get(rowIndex).isIsCompleted(); //Retorna se o projeto está concluído
            case 4:
                return "";
            case 5:
                return "";
