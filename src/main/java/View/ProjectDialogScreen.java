...
public class ProjectDialogScreen extends javax.swing.JDialog {
    ...
    ProjectController controller; //Controlador para as operações
    
    public ProjectDialogScreen(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        controller = new ProjectController(); //Criação do objeto ProjectController
    }
    ...
    private void jLabelToolBarSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelToolBarSaveMouseClicked
        ...
        try{
            if(!jTextFieldName.getText().equals("")){
                Project project = new Project(); //Criação de um novo projeto
                project.setName(jTextFieldName.getText()); //Pegue o valor no campo de texto e passe para a propriedade Name do projeto
                project.setDescription(jTextAreaDescription.getText());  //Mesma coisa para a descrição
